...
<li><a href="#"><i class="fa fa-sitemap"></i> Bycicles</a>
					<ul>
						<li><a href="post-avehical.php">Post a Bycicles</a></li>
						<li><a href="manage-vehicles.php">Manage Bycicles</a></li>
					</ul>
				</li>
			...
			<li><a href="logout.php"><i class="fa-sign-out"></i>Sign Out</a></li>
